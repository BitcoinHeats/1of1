...
/** Inline brand icons (lucide-react v1.11 dropped brand marks). */
function XIcon() {
  return (
...
export function SocialShare({ url, title, className }: SocialShareProps) {
  ...
  return (
    <div className={`flex flex-wrap items-center gap-2 ${className ?? ""}`}>
      <span className="inline-flex items-center gap-1.5 mr-1 text-sm font-medium text-muted-foreground">
